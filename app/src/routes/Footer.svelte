...
<footer class="bg-white" aria-labelledby="footer-heading">
	...
	<!-- TODO get rid of "hidden" class -->
	<div class="hidden mx-auto max-w-7xl px-6 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
	...
	<div
		class="mx-auto max-w-7xl px-6 md:flex md:items-center md:justify-between lg:px-8 py-16 sm:py-18 lg:py-24"
	>
		...
		<div class="mt-8 md:order-1 md:mt-0">
			<p class="text-center text-xs leading-5 text-gray-500">
				&copy; 2023 Halifax Carnivores. All rights reserved.
			</p>
		</div>
	</div>
</footer>
